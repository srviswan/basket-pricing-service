...
public class PricingMetrics {
    ...
    public void recordBackpressureUtilization(double utilization) {
        Gauge.builder("pricing.backpressure.utilization")
                .description("Backpressure queue utilization")
                .register(meterRegistry, utilization);
    }
    
    public void recordDroppedUpdates(long count) {
        Gauge.builder("pricing.backpressure.dropped")
                .description("Number of dropped updates due to backpressure")

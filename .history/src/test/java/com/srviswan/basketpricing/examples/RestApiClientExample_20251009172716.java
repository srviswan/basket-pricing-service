...
public class RestApiClientExample {
    ...
    public static void main(String[] args) {
        try {
            ...
            // IMPORTANT: Subscribe FIRST before getting prices
            log.info("Step 1: Subscribe to symbols");
            subscribeToSymbols();
            ...
            // Get current subscriptions
            log.info("Step 4: Get current subscriptions");
            getCurrentSubscriptions();
            
            // Unsubscribe from some symbols
            log.info("Step 5: Unsubscribe from symbols");

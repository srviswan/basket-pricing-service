...
def main():
    ...
    print("Analysis complete. Results saved to repo_structure.json")
...
def main():
    ...
    with open('refactoring_recommendations.json', 'w') as f:
        json.dump(recommendations, f, indent=2)
    
    print("Refactoring recommendations generated: refactoring_recommendations.json")
...
def generate_html_report(structure_file, recommendations_file, output_file):
    ...
    with open('refactoring_recommendations.json', 'r') as f:
...
"""
    ...
    with open('refactoring_analysis.html', 'w') as f:
        f.write(html_content)
    
    print("HTML report generated: refactoring_analysis.html")

if __name__ == "__main__":
    generate_html_report('repo_structure.json', 'refactoring_recommendations.json', 'refactoring_analysis.html')
EOF
}
